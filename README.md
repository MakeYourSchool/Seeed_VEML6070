UV-Lichtsensor
----
*(Seeed Studio Grove - I2C UV Sensor (VEML6070))*
...
Die Sensibilität des Sensors ist am höchsten bei einer Strahlung mit einer Wellenlänge zwischen 320 nm und 410 nm. Dadurch erfasst der Sensor sowohl UV-Strahlung als auch einen geringen Anteil des sichtbaren violetten Lichts.

Der Sensor kann direkt oder mithilfe des Grove Shields an einen Arduino oder Raspberry Pi angeschlossen werden. Der Sensor kommuniziert über die serielle Schnittstelle I2C.
...
[Repository von Seeed Studio](https://github.com/Seeed-Studio/Seeed_VEML6070)

[Offizielles Wiki von Seeed Studio](http://wiki.seeedstudio.com/Grove-I2C_UV_Sensor-VEML6070/)
